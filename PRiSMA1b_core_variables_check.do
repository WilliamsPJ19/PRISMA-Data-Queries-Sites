...
/*
1. dictionry (save PRiSMA-MNH-Data-Dictionary-Repository_V.2.0-SEP292022_varlist.xlsx here)
...
import excel "$dic/PRiSMA-MNH-Data-Dictionary-Repository_V.2.0-SEP292022_varlist.xlsx", sheet(`form') firstrow clear
...
***step6. store variable list 
des using "$dic/xxxxxx.dta", varlist //replace data with dict_mnh25_country, for example dict_mnh25_Pakistan
